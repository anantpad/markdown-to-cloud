...
flowchart LR
    A("Initialize Environment<br>(WSL Terminal)") --> B("Sync Local Workspace<br>(Pull from git)")
    B --> C("Launch Preview<br>(local browser)")
    C --> D("Add/Update Content<br>(update .qmd files)")
    D --> E("Publish Updates<br>(Quarto Publish)")
    E --> F("Secure Source Text<br>(Commit to git)")
```
