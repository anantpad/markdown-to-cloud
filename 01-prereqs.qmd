...
## Download Quarto
* If you're on Windows, download and run the Quarto installer directly from [Quarto](www.quarto.org) — no additional setup like WSL or a Linux environment is required. Just double-click the installer like you would for any other program.
